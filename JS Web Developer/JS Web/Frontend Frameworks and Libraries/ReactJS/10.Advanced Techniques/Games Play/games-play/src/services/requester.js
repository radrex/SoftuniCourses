...
// 1 - if token not passed (not logged in)
// 2 - if token is passed (logged in, but don't have access to the token), then it will try to get it from the local storage
