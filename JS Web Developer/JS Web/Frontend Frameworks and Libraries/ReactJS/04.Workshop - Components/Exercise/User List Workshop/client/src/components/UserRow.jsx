...
export default function UserRow({
  ...
  return (
    <tr>
      <td>
        <img src={imageUrl} alt={`${firstName} ${lastName}'s profile`} className="image" />
      </td>
      <td>{firstName}</td>
      <td>{lastName}</td>
      <td>{email}</td>
      ...
      <td className="actions">
        <button className="btn edit-btn" title="Edit" onClick={() => onOpenUserEditModalHandler(_id)}>
        ...
        <button className="btn delete-btn" title="Delete" onClick={() => onOpenUserDeleteModalHandler(_id)}>
        ...
        <button className="btn info-btn" title="Info" onClick={() => onOpenUserInfoModalHandler(_id)}>
